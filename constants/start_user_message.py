...
🧠 I will remind you when a new episode or movie comes out — no manual searching needed.  

📚 To open your library or change settings, just select the appropriate button in the menu.  

❓ If something is unclear, press «<b>Help</b>» in the menu, and I’ll guide you.  
...
🧠 Я сам напомню тебе, когда выйдет новая серия или фильм — ничего не нужно искать вручную.  

📚 Чтобы открыть библиотеку или изменить настройки — просто выбери нужную кнопку в меню.  

❓ Если что-то непонятно, нажми «<b>Помощь</b>» в меню, и я напомню тебе, как всё работает.  
...
🧠 Я нагадаю тобі, коли вийде нова серія або фільм — нічого шукати вручну не потрібно.  

📚 Щоб відкрити бібліотеку або змінити налаштування — просто обери потрібну кнопку в меню.  

❓ Якщо щось незрозуміло, натисни «<b>Допомога</b>» у меню, і я поясню.  
...
🧠 Je te rappellerai quand un nouvel épisode ou film sortira — pas besoin de chercher manuellement.  

📚 Pour ouvrir ta bibliothèque ou changer les paramètres — sélectionne le bouton correspondant dans le menu.  

❓ Si quelque chose n’est pas clair, appuie sur «<b>Aide</b>» dans le menu et je t’expliquerai.  
...
🧠 Ich erinnere dich, wenn eine neue Folge oder ein Film erscheint — kein manuelles Suchen nötig.  

📚 Um deine Bibliothek zu öffnen oder Einstellungen zu ändern — wähle einfach den entsprechenden Button im Menü.  

❓ Wenn etwas unklar ist, drücke «<b>Hilfe</b>» im Menü, und ich erkläre es dir.  

🎬 <b>Bereit zu starten🎬 ?</b>  
...
🧠 Ti ricorderò quando uscirà un nuovo episodio o film — niente ricerca manuale.  

📚 Per aprire la libreria o cambiare impostazioni, seleziona il pulsante appropriato nel menu.  

❓ Se qualcosa non è chiaro, premi «<b>Aiuto</b>» nel menu e ti guiderò.  

🎬 <b>Pronto per iniziare🎬 ?</b>  
...
🧠 새 에피소드나 영화가 출시되면 직접 검색할 필요 없이 알려드립니다.  

📚 라이브러리를 열거나 설정을 변경하려면 메뉴에서 적절한 버튼을 선택하세요.  

❓ 이해되지 않는 부분이 있으면 메뉴에서 «<b>도움말</b>»을 누르세요. 안내해 드립니다.  
...
🧠 Przypomnę Ci, gdy pojawi się nowy odcinek lub film — nie trzeba szukać ręcznie.  

📚 Aby otworzyć bibliotekę lub zmienić ustawienia — wybierz odpowiedni przycisk w menu.  

❓ Jeśli coś jest niejasne, naciśnij «<b>Pomoc</b>» w menu, a wyjaśnię Ci.  

🎬 <b>Gotowy, aby zacząć🎬 ?</b>  
Wpisz nazwę filmu.
''',
...
🧠 Avisarei quando um novo episódio ou filme for lançado — não é necessário buscar manualmente.  

📚 Para abrir a biblioteca ou alterar configurações — selecione o botão apropriado no menu.  

❓ Se algo não estiver claro, pressione «<b>Ajuda</b>» no menu e eu guiarei você.  
...
🧠 Te recordaré cuando salga un nuevo episodio o película — no necesitas buscar manualmente.  

📚 Para abrir tu biblioteca o cambiar la configuración, selecciona el botón correspondiente en el menú.  

❓ Si algo no está claro, pulsa «<b>Ayuda</b>» en el menú y te guiaré.  
...
🧠 Yeni bir bölüm veya film çıktığında seni bilgilendireceğim — elle aramana gerek yok.  

📚 Kütüphaneyi açmak veya ayarları değiştirmek için menüde uygun düğmeyi seç.  

❓ Bir şey anlaşılmadıysa, menüden «<b>Yardım</b>» a tıkla, sana rehberlik edeceğim.  

🎬 <b>Başlamaya hazır mısın🎬 ?</b>  
Bir film adı yaz.
''',
...
🧠 Připomenu vám, když vyjde nová epizoda nebo film — není třeba hledat ručně.  

📚 Chcete-li otevřít knihovnu nebo změnit nastavení, vyberte příslušné tlačítko v nabídce.  

❓ Pokud něco není jasné, stiskněte «<b>Pomoc</b>» v nabídce a vysvětlím.  
...
🧠 Ik herinner je automatisch wanneer er een nieuwe aflevering of film uitkomt — geen handmatig zoeken nodig.  

📚 Om je bibliotheek te openen of instellingen te wijzigen, kies gewoon de juiste knop in het menu.  

❓ Als iets niet duidelijk is, druk op «<b>Hulp</b>» in het menu en ik leg het uit.  

🎬 <b>Klaar om te beginnen🎬 ?</b>  
...
🧠 Automatikusan emlékeztetlek, amikor új rész vagy film jelenik meg — nincs szükség kézi keresésre.  

📚 A könyvtár megnyitásához vagy a beállítások módosításához válaszd a megfelelő gombot a menüben.  

❓ Ha valami nem világos, nyomd meg a «<b>Segítség</b>» gombot a menüben, és elmagyarázom, hogyan működik minden.  
...
🧠 Jeg minner deg automatisk når en ny episode eller film slippes — ingen manuell søking nødvendig.  

📚 For å åpne biblioteket eller endre innstillinger, velg bare riktig knapp i menyen.  

❓ Hvis noe er uklart, trykk på «<b>Hjelp</b>» i menyen, så forklarer jeg hvordan alt fungerer.  

🎬 <b>Klar til å starte🎬 ?</b>  
...
🧠 Jag påminner dig automatiskt när ett nytt avsnitt eller en film släpps — ingen manuell sökning behövs.  

📚 För att öppna biblioteket eller ändra inställningar, välj bara rätt knapp i menyn.  

❓ Om något är oklart, tryck på «<b>Hjälp</b>» i menyn, så förklarar jag hur allt fungerar.  
